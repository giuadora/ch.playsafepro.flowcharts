# Requirements Archive: v1.1 Print-Ready A4
...
- [x] **EXPORT-01**: SVG export regenerated matching new A4 layout
- [x] **EXPORT-02**: Mermaid source updated to reflect any structural changes from reorganization

### Documentation

- [x] **DOC-01**: README updated to reflect A4 print-ready format
