...
must_haves:
  truths:
    ...
    - "New playground path starts at Bauabnahme (SIA 118) then Inspektion nach Installation, with defects routed back to builder before opening"
...
**4. Neuer Spielplatz Path (starts at Bauabnahme, per locked decision):**
Per locked decisions and requirements NEW-03 through NEW-06: the new playground path begins at Bauabnahme. There are no Planung or Bau nodes -- the flowchart assumes the playground is physically built before this path begins.
...
- NEW-03 through NEW-06: New playground path nodes -- check section 4
...
2. Every requirement FLOW-01 through POST-08 (20 requirements) is traceable to at least one node or edge
